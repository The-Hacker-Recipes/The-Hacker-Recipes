...
# Enumerates all DnsRecords within the 'ADLAB.LOCAL' domain
Invoke-PassTheCert -Action 'LDAPEnum' -LdapConnection $LdapConnection -Enum 'DnsRecords' -SearchBase 'DC=ADLAB,DC=LOCAL'
```
