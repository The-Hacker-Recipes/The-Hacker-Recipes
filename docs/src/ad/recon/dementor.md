...
Dementor is a tool for [LLMNR, NBTNS, MDNS poisoning](../movement/mitm-and-coerced-authentications/llmnr-nbtns-mdns-spoofing.md). It provides an
extensible architecture to expose various rogue services.


* Support for numerous protocols (e.g. IPP, MySQL, X11, UPnP, …) (Compatibility matrix with responder is here: [Docs - Compatibility](https://matrixeditor.github.io/dementor/compat.html))
* *Attack* and *analysis* operation modes.
* Fine-grained, per-protocol configuration via a TOML file.
