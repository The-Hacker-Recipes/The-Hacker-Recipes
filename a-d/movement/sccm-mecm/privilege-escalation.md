...
The primary site server's computer account is member of the local Administrators group on the site database server and on every site server hosting the "SMS Provider" role in the hierarchy (See [SCCM Topology](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/sccm-mecm.md#topology)).
...
* automatic site assignment and automatic site-wide [client push installation](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/sccm-mecm.md#client-push-installation-1) are enabled
...
The first four requirements above apply to the [client push installation coercion technique](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/sccm-mecm.md#client-push-installation). But without them, a regular coercion technique could still be used (petitpotam, printerbug, etc.).
{% endhint %}

1. Retrieve the controlled user SID

The first step consists in retrieving the hexadecimal format of the user's SID (Security IDentifier) to grant "Full Administrator SCCM role" to, on the site database server. The hex formatted SID is needed in a part below: [https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/sccm-mecm.md#4.-obtain-an-sql-console](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/sccm-mecm.md#4.-obtain-an-sql-console "mention").
...
The target of the [NTLM relay attack](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/ntlm/relay.md) must be set to the site database server, either on the MS-SQL (port `1433/tcp`), or SMB service (port `445/tcp`) if the relayed user has admin privileges on the target. The rest of this page is focusing on relaying the authentication on the MS-SQL service.
...
Fore more insight on NTLM relay attacks and tools options, see the corresponding page on The Hacker Recipes: [NTLM Relay](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/ntlm/relay.md).

3. Authentication coercion

The primary site server's authentication can be coerced via automatic client push installation targeting the relay server with [SharpSCCM](https://github.com/Mayyhem/SharpSCCM) (C#). For more information, see the corresponding article "[Coercing NTLM authentication from SCCM](https://posts.specterops.io/coercing-ntlm-authentication-from-sccm-e6e23ea8260a)" by [Chris Thompson](https://mobile.twitter.com/\_mayyhem). Alternatively, the server's authentication could be coerced with other, more common, coercion techniques ([PrinterBug](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/print-spooler-service/printerbug.md), [PetitPotam](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-efsr.md), [ShadowCoerce](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-fsrvp.md), [DFSCoerce](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-dfsnm.md), etc.).

{% tabs %}
{% tab title="UNIX-like" %}
From UNIX-like systems, authentication can be coerced through [PrinterBug](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/print-spooler-service/printerbug.md), [PetitPotam](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-efsr.md), [ShadowCoerce](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-fsrvp.md), [DFSCoerce](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-dfsnm.md), etc. (not based on triggering the client push installation).
...
The target of the [NTLM relay attack](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/ntlm/relay.md) must be set to the SMS Provider server, on the HTTP/S service (port `80/tcp` or `443/tcp`).
...
The target of the [NTLM relay attack](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/ntlm/relay.md) must be set to the active site server, on the SMB service.
...
The passive site server's authentication can be coerced with ([PrinterBug](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/print-spooler-service/printerbug.md), [PetitPotam](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-efsr.md), [ShadowCoerce](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-fsrvp.md), [DFSCoerce](https://github.com/ShutdownRepo/The-Hacker-Recipes/blob/master/ad/movement/sccm-mecm/mitm-and-coerced-authentications/ms-dfsnm.md), etc.).
