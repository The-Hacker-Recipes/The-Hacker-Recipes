...
* several authentication methods: like [pass-the-hash](../../lm-and-ntlm/pass-the-hash.md) \(NTLM\), or [pass-the-ticket](../../kerberos/pass-the-ticket.md) \(Kerberos\)
...
Recovered credential material could be either plaintext passwords or NT hash that can be used with [pass the hash](../../lm-and-ntlm/pass-the-hash.md) \(depending on the context\).
