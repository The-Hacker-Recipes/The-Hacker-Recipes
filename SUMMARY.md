...
* [Configuration](web/configuration/README.md)
  ...
  * [🛠️ HTTP security headers](web/configuration/http-headers/README.md)
    ...
    * [CORS (Cross-Origin Resource Sharing)](web/configuration/http-headers/cors-cross-origin-resource-sharing.md)
    * [CSP (Content Security Policy)](web/configuration/http-headers/csp-content-security-policy.md)
