...
* [Movement](active-directory-domain-services/movement/README.md)
  ...
  * [MITM and and coerced auths](active-directory-domain-services/movement/mitm-and-coerced-authentications/README.md)
    ...
    * [ADIDNS poisoning](active-directory-domain-services/movement/mitm-and-coerced-authentications/adidns-spoofing.md)
    * [WPAD spoofing](active-directory-domain-services/movement/mitm-and-coerced-authentications/wpad-spoofing.md)
    * [MS-EFSR abuse \(PetitPotam\)](active-directory-domain-services/movement/mitm-and-coerced-authentications/ms-efsr.md)
    * [MS-RPRN abuse \(PrinterBug\)](active-directory-domain-services/movement/mitm-and-coerced-authentications/ms-rprn.md)
    * [PushSubscription abuse](active-directory-domain-services/movement/mitm-and-coerced-authentications/pushsubscription-abuse.md)
    * [🛠️ NBT Name Overwrite](active-directory-domain-services/movement/mitm-and-coerced-authentications/nbt-name-overwrite.md)
  ...
  * [NTLM](active-directory-domain-services/movement/ntlm/README.md)
    * [Capture](active-directory-domain-services/movement/ntlm/capture.md)
    * [Relay](active-directory-domain-services/movement/ntlm/relay.md)
    * [Pass the hash](active-directory-domain-services/movement/ntlm/pass-the-hash.md)
  * [Kerberos](active-directory-domain-services/movement/kerberos/README.md)
    ...
    * [Pass the cache](active-directory-domain-services/movement/kerberos/pass-the-cache.md)
    * [Forged tickets](active-directory-domain-services/movement/kerberos/forged-tickets.md)
    * [ASREProast](active-directory-domain-services/movement/kerberos/asreproast.md)
    * [Kerberoast](active-directory-domain-services/movement/kerberos/kerberoast.md)
    * [Delegations](active-directory-domain-services/movement/kerberos/delegations.md)
    * [Shadow Credentials](active-directory-domain-services/movement/kerberos/shadow-credentials.md)
  * [Access Control Entries \(ACEs\)](active-directory-domain-services/movement/access-control-entries/README.md)
    * [AddMember](active-directory-domain-services/movement/access-control-entries/addmember.md)
    * [ForceChangePassword](active-directory-domain-services/movement/access-control-entries/forcechangepassword.md)
    * [Targeted Kerberoasting](active-directory-domain-services/movement/access-control-entries/targeted-kerberoasting.md)
    * [Logon script](active-directory-domain-services/movement/access-control-entries/logon-script.md)
    * [ReadLAPSPassword](active-directory-domain-services/movement/access-control-entries/readlapspassword.md)
  ...
  * [Netlogon](active-directory-domain-services/movement/netlogon/README.md)
    * [ZeroLogon](active-directory-domain-services/movement/netlogon/zerologon.md)
  * [🛠️ Certificate Services \(AD-CS\)](active-directory-domain-services/movement/certificate-services-ad-cs.md)
  * [Exchange services](active-directory-domain-services/movement/exchange-services/README.md)
    * [🛠️ PrivExchange](active-directory-domain-services/movement/exchange-services/privexchange.md)
