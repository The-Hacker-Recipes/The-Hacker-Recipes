...
This abuse can be carried out when controlling an object that has `WriteProperty`, `GenericWrite` or `GenericAll` over a target user (i.e. member of the [Account Operator](../builtin-groups.md) group).
