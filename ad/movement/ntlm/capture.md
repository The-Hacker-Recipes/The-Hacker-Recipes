...
{% hint style="success" %}
Machine account NT hashes can be used with the [Silver Ticket](../kerberos/forged-tickets/#silver-ticket) or [S4U2self abuse](../kerberos/delegations/s4u2self-abuse.md) techniques to gain admin access to it.
{% endhint %}
