...
1. be in a domain with a Domain Functionnal Level of Windows Server 2016 or above (or at least one Domain Controller running Windows Server 2016 or above). _At the time of writing, October 27th 2021, researchers are still trying to figure out which requirement is true: DFL>=2016 or DC>=2016._&#x20;
