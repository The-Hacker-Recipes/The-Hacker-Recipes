...
![Setting up the SOCKS proxy servers (with SSH)](../../.gitbook/assets/carbon\(3\).png)

![Setting up the SOCKS proxy client (proxychains)](../../.gitbook/assets/carbon\(1\).png)

![Attacking the target through the chain of SOCKS proxies](../../.gitbook/assets/carbon\(4\).png)
